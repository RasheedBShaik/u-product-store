...
"[project]/frontend/app/Product.tsx [app-rsc] (ecmascript)", ((__turbopack_context__, module, exports) => {

fetch('https://product-store-zgez.onrender.com/api/products').then((res)=>res.json()).then((data)=>console.log(data)).catch((err)=>console.error(err));
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8b93a0db._.js.map